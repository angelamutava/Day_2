import unittest
import word_count as testcases
...
class TestWordCounts(unittest.TestCase):
    ...
    def test_word_occurance3(self):
        self.assertDictEqual(
            ...
            testcases.words("one fish two fish red fish blue fish"),
    ...
    def test_word_occurance4(self):
        self.assertDictEqual(
            ...
            testcases.words('car : carpet as java : javascript!!&@$%^&'),
    ...
    def test_word_occurance5(self):
        self.assertDictEqual(
            {'testing': 2, 1: 1, 2: 1},
            testcases.words('testing 1 2 testing'),
    ...
    def test_word_occurance7(self):
        self.assertDictEqual(
            ...
            testcases.words('¡Hola! ¿Qué tal? Привет!'),
    ...
    def test_word_occurance9(self):
        self.assertDictEqual(
            {'hello': 1, 'world': 1},
            testcases.words('hello\tworld'),
            msg='should not count tabs'
        )

    def test_word_occurance10(self):
        self.assertDictEqual(
            {'hello': 1, 'world': 1},
            testcases.words('hello  world'),
